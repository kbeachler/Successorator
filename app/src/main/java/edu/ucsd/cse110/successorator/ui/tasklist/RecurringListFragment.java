...
public class RecurringListFragment extends Fragment{
    ...
    private RTaskListAdapter adapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.adapter = new RTaskListAdapter(requireContext(), List.of(), activityModel::deleteR);
        activityModel.getRecurringTasks().observe(tasks -> {
