...
public class TaskEntity {
    ...
    TaskEntity(@NonNull String task_name, int sortOrder, boolean marked, String context){
    ...
    public static TaskEntity fromTask(@NonNull Task Task) {
        var task = new TaskEntity(Task.task_name(), Task.sortOrder(), Task.getMark(), Task.context());
        task.id = Task.id();
        return task;
    }
