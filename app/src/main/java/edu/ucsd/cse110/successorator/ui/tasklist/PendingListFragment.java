...
public class PendingListFragment extends Fragment{
    ...
    private PTaskListAdapter adapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.adapter = new PTaskListAdapter(requireContext(), List.of(), activityModel::delete, activityModel::toToday, activityModel::toTomorrow, activityModel::finish, activityModel::mark);
        activityModel.getPendingTasks().observe(tasks -> {
